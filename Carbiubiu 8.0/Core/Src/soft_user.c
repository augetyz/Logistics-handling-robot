...
{
    Usart_SendString((uint8_t *)"C");
}
void Camera_color_circle_Red(void)
{
    Usart_SendString((uint8_t*)"F");
}
void Camera_color_circle_Green(void)
{
    Usart_SendString((uint8_t*)"C");
}
void Camera_color_circle_Blue(void)
{
    Usart_SendString((uint8_t*)"E");
}
void Camera_color_Stacking_Blue(void)
{
    Usart_SendString((uint8_t*)"I");
}
void Camera_color_Stacking_Red(void)
{
    Usart_SendString((uint8_t*)"H");
}
void Camera_color_Stacking_Green(void)
{
    Usart_SendString((uint8_t*)"G");
}
void GM65_work(void)
{
    uint8_t str[9]={0X7E,0X00,0X08,0X01,0X00,0X02,0X01,0XAB,0XCD};
    HAL_UART_Transmit(&huart6, str, 9, 100);
}
