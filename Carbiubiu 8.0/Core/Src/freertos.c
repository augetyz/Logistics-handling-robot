...
//                    osDelay(servo_time_use.time);
        ...
        case To_Turn_2:// 右行前往成品区
            if (crosswise_angle_distance(angle_standard, imu_date, distance_now, 940) == 1) //
            {
                vTaskSuspendAll();
        ...
        case At_Turn_2:// 直线前进到达成品区
            if (advance_angle_distance(angle_standard, imu_date, distance_now, -820) == 1) //
            {
                vTaskSuspendAll();
        ...
        case Adjust_position:
            if (advance_angle_distance(angle_standard, imu_date, distance_now, 480) == 1) //
            {
        ...
        case Back_Take_thing_1: 
            if (crosswise_angle_distance(angle_standard, imu_date, distance_now, -1555) == 1) //
            {
