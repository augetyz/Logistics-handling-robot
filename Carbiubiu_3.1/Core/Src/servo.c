...
servo_status servo_motion[] =
    {
        ...
        {-90.8, -73.9, -139.8, -37.5, -43.9, 0, 1000}, // 二维码识别动作2
        ...
        {-30.6, -0.1, -117.4, 1.3, -42, 0, 1000},      // 放到一号物料台9
        {-30.6, -0.1, -117.4, 1.3, -15.8, 0, 200},     // 松爪10
        ...
        {1.8, 1.4, -128.8, 14.0, -43, 0, 1000},        // 放到二号物料台17
        {1.8, 1.4, -128.8, 14.0, -20.8, 0, 200},       // 松爪18
        ...
        {-35.6, -121.0, 24.5, -54.2, -15.8, 0, 2000}, // 红色色环放置27
        {-0.1, -108.5, 64.8, -77.5, -15.8, 0, 2000},  // 绿色色环放置28
        {32.8, -121.9, 24.5, -54.7, -15.8, 0, 2000},  // 蓝色色环放置29
};
