...
void DEBUG_USART_IRQHandler(void)                	//串口1中断服务程序
	...
	if(USART_GetITStatus(DEBUG_USARTx, USART_IT_RXNE) != RESET)  
	{
		...
		switch(a[num])
		{
			case '1': go(0,1,30);break;
			case '2': go(0,-1,30);break;
			case '3': go(1,0,30);break;
			case '4': go(-1,0,30);break;
			case '5': go(1,1,30);break;
			case '6': go(-1,-1,30);break;
			case '0': go(1,1,0);break;
			case '9': goal1=30,goal2=-30,goal3=30,goal4=-30;break;
		}
