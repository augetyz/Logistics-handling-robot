...
servo_status servo_motion[] =
    {
        ...
        {-35.6, -85.0, 117.7, -109.2, -5.8, 0, 400}, // 红色色环放置松爪后收回_2_23
        {-0.1, -73.5, 136.8, -109.5, -5.8, 0, 400},  // 绿色色环放置松爪后收回_2_24
        {35.8, -85.0, 117.7, -109.2, -5.8, 0, 400},  // 蓝色色环放置松爪后收回_2_25
        ...
        {-32.9, -41.2, 135.8, -127, -5.8, 0, 300}, // 红色色环码垛松爪后收回_2_33
        {2.3, -30.4, 135.8, -127, -5.8, 0, 300},   // 绿色色环码垛松爪后收回_2_34
        {35.8, -41.2, 135.8, -127, -5.8, 0, 300},  // 蓝色色环码垛松爪后收回_2_35


        {-34.6,-120.8,26.0,-54.9,-34.4, 0, 300},    // 红色色环放置单独急速抓取36
        {0.8,-110.6,73.4,-94.2,-33.7, 0, 300},      // 绿色色环放置单独急速抓取37
