...
servo_status servo_motion[] =
{
    ...
    {   2.8,   35.4,  -10.1,   17.0,  -25.3,    0,  300}, // 抓取物料动作5
    {  73.0,  -17.3,   59.3,   17.0,  -25.3,    0, 600}, // 准备放置物料动作6
    
    {  73.6,  -31.3,   37.7,   17.0,  -25.4,    0,  500}, // 放置物料到台子7
    {  73.6,  -31.3,   37.7,  -35.0,  -25.4,    0,  300}, // 在物料台松爪8
    ...
    {  73.1,  -36.9,   44.7,  -26.5,  -40.0,    0,  500}, // 下落到物料台上13
    {  73.1,  -37.0,   44.7,   17.0,  -17.0,    0,  300}, // 合爪14
    {  73.1,  -17.3,   56.3,   17.0,  -17.0,    0,  400}, // 抓起15
    
    { -89.5,  -36.1,   59.2,   17.0,  -43.0,    0, 1000}, // 将物料拿到正前方，准备放置16
    
    { -88.3,   57.7,  -81.6,   17.0,  -30.0,    0, 1000}, // 放到二号色环17
    { -88.3,   57.7,  -81.6,  -35.5,  -17.0,    0,  300}, // 松爪18
    { -87.1,    5.1,  -11.1,  -35.5,  -17.0,    0,  300}, // 完成放置抬起19
    
    { -56.5,   65.6,  -51.2,   17.0,  -30.0,    0, 1000}, // 放到一号色环20
    { -56.5,   65.6,  -51.2,  -35.5,  -17.0,    0,  300}, // 松爪21
    { -56.2,   29.3,  -24.3,  -35.5,  -17.0,    0,  300}, // 完成放置抬起22
    
    { -120.3,  60.6,  -55.3,   17.0,  -43.0,    0, 1000}, // 放到三号色环23
    { -120.3,  60.6,  -55.3,  -35.5,  -17.0,    0,  300}, // 松爪24
    { -120.4,  24.5,  -28.3,  -35.5,  -17.0,    0,  300}, // 完成放置抬起25
    
    { -89.2,  -31.9,   44.6,  -35.5,   -0.6,    0,  500}, // 放置物料中间动作26
    //红色物料码垛
    { -50.9,   29.2,  -28.4,   17.0,   -5.8,    0,  500}, // 码垛放置27
    { -50.9,   29.2,  -28.4,  -35.5,   -5.8,    0,  300}, // 码垛松爪28
    { -50.9,   -9.0,   24.6,  -35.7,   -5.8,    0,  300}, // 码垛抬起29
    //绿色物料码垛
    { -84.0,   10.4,  -40.7,   17.0,  -40.0,    0,  500}, // 码垛放置30
    { -84.0,   10.4,  -40.7,  -35.6,  -40.0,    0,  300}, // 码垛松爪31
    { -85.7,  -26.7,   34.9,  -35.7,  -40.0,    0,  300}, // 码垛抬起32
    //蓝色物料码垛
    { -121.7,  20.6,  -33.5,   17.0,  -40.0,    0,  500}, // 码垛放置33
    { -121.7,  20.6,  -33.5,  -35.6,  -40.0,    0,  300}, // 码垛松爪34
    { -121.4, -17.2,   32.5,  -35.7,  -40.0,    0,  300}, // 码垛抬起35
    
    { -119.0,  45.8,   18.2,   17.0,  -40.0,    0,  500}, // 拿着物料扫描红色色环36
    { -88.5,   21.6,   22.4,   17.0,  -40.0,    0,  500}, // 拿着物料扫描绿色色环37
    { -57.9,   45.8,   18.2,   17.0,  -40.0,    0,  500}, // 拿着物料扫描蓝色色环38
    
    { -86.0,  -28.3,   53.8,   14.7,  -40.0,    0,  800}, // 码垛中间动作合爪 39
