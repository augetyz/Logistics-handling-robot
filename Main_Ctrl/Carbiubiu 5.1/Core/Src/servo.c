...
servo_status servo_motion[] =
    {
        ...
        {-34.6,-120.8,26.0,-54.9,-34.4, 0, 500},        // 红色色环放置单独急速抓取36
        {0.8,-110.6,66.5,-94.2,-33.7, 0, 500},          // 绿色色环放置单独急速抓取37
        ...
        {0.8,-90,120,-110,-33.7, 0, 1000},          // 绿色暂存区放置防止碰到障碍挡板额外添加动作，在21动作前执行45
        
        {0.8, 24.1, -75.4, -52.0, -0.60, 0, 1000},    // 颜色识别动作46
