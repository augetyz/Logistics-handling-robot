...
#define IDR_color_grab_x 1110
#define IDR_color_grab_y 1855

#define IDR_color_put_x 1978
#define IDR_color_put_y 1185
...
void doing_Task(void const *argument)
{
    ...
    for (;;)
    {
        ...
        case target_location:
            if (abs(IDR_date_goal.IDR_X - IDR_date_use.IDR_X) > 4)
            {
            ...
            else if (abs(IDR_date_goal.IDR_Y - IDR_date_use.IDR_Y) > 4)
            {
