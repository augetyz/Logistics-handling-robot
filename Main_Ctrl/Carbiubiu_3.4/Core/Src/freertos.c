...
#define IDR_color_put_x 1953 // 粗加工区定位
// #define IDR_color_put_y 1175
#define IDR_color_put_y 1180

#define IDR_color_put2_x 1813 // 暂存区定位
#define IDR_color_put2_y 1176

#define IDR_color_home_x 130 // 启停区定位
...
void IMU_Task(void const *argument)
{
    ...
    for (;;)
    {
        ...
        if (num > 20)
        {
            Uart5_LCD_show_Angle(imu_car.IMU[2]);
            num = 0;
        }
    }
