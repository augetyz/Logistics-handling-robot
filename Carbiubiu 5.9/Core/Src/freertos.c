...
//                color_date_last.date[1]=color_date.date[1];
        ...
        case Start:// 开始向左走
            ...
            if (crosswise_angle_distance(angle_standard, imu_date, distance_now, -115) == 1) // 离开出发点向左 115 mm
            {
        ...
        case To_QR_Code:                                                                  // 前进到二维码区域
            if (advance_angle_distance(angle_standard, imu_date, distance_now, 420) == 1) // 前进 440 mm到达二维码扫描区
            {
                speed_CTRL(0, 0, 0, 0);   // 刹车
