...
//色环逆解调
//red
#define  Red_Xangle_Kp      0.05
#define  Red_Ychange_K      0.4
#define  Red_Xangle         22      //左减右加
#define  Red_Ychange       -370     //前减后加
//green
#define  Green_Xangle_Kp    0.05
#define  Green_Ychange_K    0.4
#define  Green_Xangle       18    
#define  Green_Ychange     -415
//blue
#define  Blue_Xangle_Kp     0.05
#define  Blue_Ychange_K     0.4
#define  Blue_Xangle        25
#define  Blue_Ychange      -382
...
servo_status servo_motion[] =
{
    ...
    {   2.5,   33.6,   26.8,  -35.3,  -25.3,    0, 800}, // 物料识别动作3
    {   1.1,   15.4,  -18.1,  -35.1,  -25.3,    0,  300}, // 准备抓取物料4
    {   2.8,   35.4,  -10.1,   14.0,  -25.3,    0,  300}, // 抓取物料动作5
    {  73.0,  -17.3,   59.3,   14.0,  -25.3,    0, 1000}, // 准备放置物料动作6

    {  73.6,  -43.3,   57.7,   14.0,  -25.4,    0,  500}, // 放置物料到台子7
    {  73.6,  -43.3,   57.7,  -35.0,  -25.4,    0,  300}, // 在物料台松爪8
    {  73.1,  -33.3,   58.3,  -35.7,  -25.3,    0,  400}, // 抬高中间动作9
    {  73.7,  -17.5,   57.5,  -35.7,  -25.3,    0, 600}, // 完成放置10

    {   1.3,   -2.1,   33.8,  -35.1,  -14.4,    0,  300}, // 中间动作11  3动作和4动作之间的中间动作11

    {  73.1,  -17.3,   59.3,  -35.5,  -43.0,    0, 1000}, // 准备抓取物料12
    {  73.1,  -43.3,   53.7,  -35.5,  -43.0,    0,  500}, // 下落到物料台上13
    {  73.1,  -43.3,   53.7,   14.0,  -14.0,    0,  300}, // 合爪14
    {  73.1,  -17.3,   56.3,   14.0,  -14.0,    0,  400}, // 抓起15

    { -89.5,  -36.1,   59.2,   14.0,  -43.0,    0, 1000}, // 将物料拿到正前方，准备放置16

    { -88.3,   57.7,  -81.6,   14.0,  -30.0,    0, 1000}, // 放到二号色环17
    { -88.3,   57.7,  -81.6,  -35.5,  -14.0,    0,  300}, // 松爪18
    { -87.1,    5.1,  -11.1,  -35.5,  -14.0,    0,  300}, // 完成放置抬起19

    { -56.5,   65.6,  -51.2,   14.0,  -30.0,    0, 1000}, // 放到一号色环20
    { -56.5,   65.6,  -51.2,  -35.5,  -14.0,    0,  300}, // 松爪21
    { -56.2,   29.3,  -24.3,  -35.5,  -14.0,    0,  300}, // 完成放置抬起22

    { -120.3,  60.6,  -55.3,   14.0,  -43.0,    0, 1000}, // 放到三号色环23
    { -120.3,  60.6,  -55.3,  -35.5,  -14.0,    0,  300}, // 松爪24
    { -120.4,  24.5,  -28.3,  -35.5,  -14.0,    0,  300}, // 完成放置抬起25

    { -89.2,  -31.9,   44.6,  -35.5,   -0.6,    0,  500}, // 放置物料中间动作26

    { -50.9,   29.2,  -28.4,   14.0,   -5.8,    0,  800}, // 码垛放置27
    { -50.9,   29.2,  -28.4,  -35.5,   -5.8,    0,  300}, // 码垛松爪28
    { -50.9,   -9.0,   24.6,  -35.7,   -5.8,    0,  500}, // 码垛抬起29

    { -84.0,   10.4,  -40.7,   14.0,  -40.0,    0,  800}, // 码垛放置30
    { -84.0,   10.4,  -40.7,  -35.6,  -40.0,    0,  300}, // 码垛松爪31
    { -85.7,  -26.7,   34.9,  -35.7,  -40.0,    0,  500}, // 码垛抬起32

    { -119.7,  20.6,  -33.5,   14.0,  -40.0,    0,  800}, // 码垛放置33
    { -119.7,  20.6,  -33.5,  -35.6,  -40.0,    0,  300}, // 码垛松爪34
    { -121.4, -17.2,   32.5,  -35.7,  -40.0,    0,  500}, // 码垛抬起35

    { -119.0,  45.8,   18.2,   14.0,  -40.0,    0,  500}, // 拿着物料扫描红色色环36
    { -88.5,   21.6,   22.4,   14.0,  -40.0,    0,  500}, // 拿着物料扫描绿色色环37
    { -57.9,   45.8,   18.2,   14.0,  -40.0,    0,  500}, // 拿着物料扫描蓝色色环38

    { -86.0,  -28.3,   53.8,    4.7,  -40.0,    0, 1200}, // 码垛中间动作合爪 39
    { -86.0,  -28.3,   53.8,  -30.7,  -40.0,    0, 1200}, // 码垛中间动作松爪 40
};
